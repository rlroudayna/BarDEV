    ...
    <div className="p-3 space-y-5 bg-gray-10 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 bg-card p-4 rounded-xl shadow-md">
        ...
        <input
          ...
          className="bg-background border border-border rounded-lg px-3 py-2 text-sm text-foreground outline-none focus:ring-2 focus:ring-ring transition"
      ...
      <div className="bg-card rounded-xl border border-gray-300 shadow-sm overflow-x-auto">
        <table className="w-full min-w-[800px] text-sm text-left border-collapse">
          ...
          <thead className="bg-[#E30613] border-b border-gray-400">
            <tr>
              <th className="px-6 py-5 font-semibold text-white">Nom</th>
              <th className="px-5 py-5 font-semibold text-white">
                N° de Projet
              </th>
              <th className="px-2 py-5 font-semibold text-white">Client</th>
              <th className="px-4 py-5 font-semibold text-white">Demandeur</th>
              <th className="px-3 py-5 font-semibold text-white">Statut</th>
              <th className="px-5 py-5 font-semibold text-white">Validation</th>
              <th className="px-3 py-5 font-semibold text-white">Date</th>
              <th className="px-5 py-5 font-semibold text-white">Shift</th>
              <th className="px-5 py-5 text-right font-semibold text-white">
                Actions
              </th>
            </tr>
          </thead>
              ...
              >
                ...
                <td className="px-1 py-4">
                  <div className="flex items-center gap-2">
                    ...
                    {/* Actions réservées ADMIN + CHARGE_ESSAI */}
                    {canEdit && (
                      <>
                        {/* Modifier */}
                        <button
      ...
      {showModal && (
        <div className="fixed inset-0 bg-foreground/10 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-card w-full max-w-[700px] max-h-[95vh] overflow-hidden rounded-xl flex flex-col shadow-2xl">
                ...
                <button
                  ...
                  className={`px-6 py-3 font-semibold text-sm transition ${
                    activeTab === tab.id
                      ...
                      : "text-muted-foreground-500 hover:bg-gray-50"
                  }`}
                >
                  {tab.label}
                </button>
            ...
            <div className="flex-1 overflow-y-auto px-8 bg-card">
              {" "}
              ...
              >
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          className="w-full border border-gray-300 bg-background text-foreground rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-gray-200 transition"
                        >
                          ...
                          {form.temperatureRegulationClim && (
                            <div className="mt-2">
                              ...
                              <input
                                ...
                                onChange={handleChange}
                                className="w-full border border-border bg-background text-foreground p-2 rounded-lg text-xs mt-1 outline-none focus:ring-2 focus:ring-ring transition"
                                placeholder="Ex: 21"
                              />
                            </div>
                          )}
                ...
                {activeTab === "mesuresAux" && (
                  <div className="space-y-6">
                    ...
                    <section className="bg-card p-6 rounded-xl border border-gray-300">
                          ...
                          >
                            ...
                            {!!form[xcuKey] && (
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pl-8 animate-in slide-in-from-left-2">
                                <div className="space-y-1">
                                  <label className="text-[10px] font-bold text-gmuted-foregroundray-500 uppercase">
                                    Software{num} *
                                  </label>
                                  <input
                                    type="file"
                        ...
                        {form.acquisitionEOBD && (
                          <div className="pl-8 animate-in slide-in-from-top-2">
                            ...
                            <select
                              ...
                              required
                              disabled={isView}
                              className="w-full md:w-1/2 border-1  p-2 rounded-lg bg-card outline-none focus:ring-2 focus:ring-red-200"
                            >
                              <option value="">-- Sélectionner --</option>
                        ...
                        {mesureItems.map(
                          (item) =>
                            form[item.id] && (
                              <div
                                key={item.id}
                                className="p-4 border border-gray-200 rounded-xl bg-card shadow-sm"
                              >
                                {/* Header */}
