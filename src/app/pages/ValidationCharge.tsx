    ...
    try {
      await authFetch(`/validation_charge/valider/${id}`, {
        ...
        body: JSON.stringify({
          ...
          fichierINCA: "test.dat",
          fichierBaR: "test.xlsx",
          fichierChecklist: "test.xlsx",
        }),
      });
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-semibold text-black mb-2">
          Validation Chargé d'essai - Essai du 05/03/2026
        </h1>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm px-3 py-2">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="border border border-[#E0E0E0] rounded-lg p-3 text-center hover:border-[#E30613] transition-colors cursor-pointer">
            <Upload className="w-6 h-6 text-gray-400 mx-auto mb-1" />
            <div className="text-xs font-medium mb-1">Acquisition INCA</div>
            <div className="text-[10px] text-gray-500">.dat, .mf4</div>
          </div>

          <div className="border border border-[#E0E0E0] rounded-lg p-2 text-center hover:border-[#E30613] transition-colors cursor-pointer">
            <Upload className="w-6 h-6 text-gray-400 mx-auto mb-1" />
            <div className="text-xs font-medium mb-0.5">Fichier BàR</div>
            <div className="text-[10px] text-gray-500">.xlsx</div>
          </div>

          <div className="border border border-[#E0E0E0] rounded-lg p-2 text-center hover:border-[#E30613] transition-colors cursor-pointer">
            <Upload className="w-6 h-6 text-gray-400 mx-auto mb-1" />
            <div className="text-xs font-medium mb-0.5">Checklist</div>
            <div className="text-[10px] text-gray-500">.xlsx</div>
          </div>
        </div>
      </div>
